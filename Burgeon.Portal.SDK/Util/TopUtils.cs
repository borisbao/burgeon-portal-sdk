...
namespace Top.Api.Util
{
    ...
    public abstract class TopUtils
    {
        ...
        public static string SignBurgeonPortalRequest(string appKey, string appSecret, string timestamp)
        {
            appSecret = MD5_Encrypt(appSecret);
            return MD5_Encrypt(appKey + timestamp + appSecret);
        }
        ...
        {
            return JsonConvert.DeserializeObject(json) as IDictionary;
        }
